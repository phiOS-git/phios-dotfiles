...
A `/etc/udev/hwdb.d/` rule was planned, mapping the volume and brightness
keys' raw codes to `KEYBOARD_KEY_<code>=volumeup|...`. That premise turned
out to be wrong: the kernel already reports **standard, correctly-named** HID
